...
const DEMO_PRESETS: DemoPreset[] = [
  {
    label: "West Village → Greenwich",
    kind: "risk",
    originText: "West Village waterfront",
    destText: "Greenwich Village",
    origin: [-74.014654, 40.731956],
    destination: [-73.997081, 40.730567],
  },
  {
    label: "Bed-Stuy short trip",
    kind: "risk",
    originText: "Bed-Stuy / Crown Heights",
    destText: "Crown Heights south",
    origin: [-73.918526, 40.681589],
    destination: [-73.915538, 40.666493],
  },
  {
    label: "UES/Harlem → UWS",
    kind: "risk",
    originText: "East Harlem / UES edge",
    destText: "Upper West Side",
    origin: [-73.950168, 40.794315],
    destination: [-73.989685, 40.785783],
  },
  {
    label: "Red Hook / Carroll Gdns",
    kind: "risk",
    originText: "Carroll Gardens edge",
    destText: "Red Hook",
    origin: [-74.001238, 40.679959],
    destination: [-74.013296, 40.668198],
  },
  {
    label: "Downtown Bk → Williamsburg",
    kind: "mode",
    originText: "Downtown Brooklyn",
    destText: "Williamsburg",
    origin: [-73.974891, 40.701497],
    destination: [-73.954428, 40.735184],
  },
  {
    label: "Midtown E → Hudson Yards",
    kind: "mode",
    originText: "Midtown East",
    destText: "Hudson Yards",
    origin: [-73.971083, 40.764206],
    destination: [-74.014574, 40.745343],
  },
  {
